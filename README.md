...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yecu1fk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yecu1fk.containers.anotherwebservice.com/
...
```
git clone git@github.com:kikweeYT/container-yecu1fk.git
cd container-yecu1fk
```
...
```
docker attach container-yecu1fk
```
